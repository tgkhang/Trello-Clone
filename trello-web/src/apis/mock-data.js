export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Practice MERN Stack',
    description: 'Pro MERN stack Course',
    type: 'public', // 'private'
    ownerIds: [], // users who are Admin of the board
    memberIds: [], // users who are normal members of the board
    columnOrderIds: ['column-id-01', 'column-id-03', 'column-id-02', 'column-id-04'], // Order / position of Columns in a board
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2FyZHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60',
      ...
      },
      {
        ...
        // FE_PlaceholderCard If card is empty
        // invisible to user
        // id: collumnId + '-placeholder-card'
        cards: [
          {
